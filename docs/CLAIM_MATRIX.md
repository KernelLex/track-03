...
| Claim | Value | Regenerate | Guarded by |
|---|---|---|---|
| Test suite | 1,477 collected / 1,466 passing / 11 skipped | `uv run pytest` | `tests/test_documented_test_counts.py` — fails the build if README or LIMITATIONS drift from a real collection |
